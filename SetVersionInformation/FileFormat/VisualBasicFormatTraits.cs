// --------------------------------------------------------------------------------------------------------------------
// <copyright file="VisualBasicFormatTraits.cs" company="Twaddle Software">
//   Copyright (c) Twaddle Software
// </copyright>
// <summary>
//   The VB.NET file format traits.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SetVersionInformation.FileFormat
{
    ...
    /// The VB.NET file format traits.
    /// </summary>
    internal sealed class VisualBasicFormatTraits : IAssemblyInfoFormatTraits
    {
        #region Properties
